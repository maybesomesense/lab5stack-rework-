...
int main()
{
	...
	do
	{
		...
		mistake* mistakes = analyzeStack(string, &mistakesCount);	// функция, которая определяет позиции ошибок в расстановке скобок в строке
		showResult(mistakes, mistakesCount, string, length);	// выводим ошибки на экран, если их нет - выводим соответствующее сообщение
